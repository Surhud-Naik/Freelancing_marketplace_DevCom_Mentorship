...
export default function Maincontent() {
  ...
  return (
    <div  class = "mainContent" >
      <Header active = {active} setActive = {setActive} hireOrFreeLance={hireOrFreeLance} setHireOrFreeLance = {setHireOrFreeLance} phase = {phase} setPhase = {setPhase}></Header>
      

      {hireOrFreeLance ? 
      <div> <Searchtool></Searchtool> <Hotpicks></Hotpicks> </div>
      :  content
      }
    </div>
  )  
